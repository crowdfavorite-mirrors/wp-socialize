...
class SocializeAdmin {
	...
	function socialize_admin_process($post_ID) {
		...
		if(isset($_POST['hide_alert']) && ($_POST['hide_alert']>0)){ array_push($socializemetaarray, $_POST['hide_alert']); }
		if(isset($_POST['socialize_text']) && ($_POST['socialize_text']!="")){ $socializemetaarray_text = $_POST['socialize_text']; }
	...
	function socialize_show_plugin_support() {
		...
		return $this->socialize_postbox('socialize-support', 'Support', $content);
	}
	...
	function socialize_show_donate() {
		...
		return $this->socialize_postbox('socialize-donate', 'Donate & Share', $content);
	}
	...
	function socialize_show_blogfeed() {
		...
		return $this->socialize_postbox('socialize-blog-rss', 'Tips and Tricks', $content);
	}
	...
	function socialize_display_admin(){
		$socialize_settings = $this->process_socialize_display_admin();
		$socializemeta = explode( ',', $socialize_settings['sharemeta']);
		...
		if ( function_exists('wp_nonce_field') ){ $general_content .= wp_nonce_field('socialize-update-display_options','_wpnonce',true,false); }
		...
		$general_content .= '<p><strong>' . __("Show/Hide Inline Buttons") . '</strong></p>';
		...
		$general_content .= '<p><input type="checkbox" name="socialize_display_feed" ' .checked($socialize_settings['socialize_display_feed'], 'on', false) . ' />
					Feeds Entries</p>';
		$wrapped_content .= $this->socialize_postbox('socialize-settings-general', 'Inline Buttons Display Settings', $general_content);
		...
		$alert_content .= '<p><input type="checkbox" name="socialize_alert_box_pages" ' .checked($socialize_settings['socialize_alert_box_pages'], 'on', false) . ' />
					Single Pages</p>';
		$wrapped_content .= $this->socialize_postbox('socialize-settings-alert', '\'Call To Action\' Box Settings', $alert_content);
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-alert', 'Advanced: Edit Template and CSS', $template_content);

		$this->socialize_admin_wrap('Socialize: Display Settings', $wrapped_content);
	}
	...
	function process_socialize_display_admin(){
		...
		if ( !empty($_POST['socialize_option_submitted']) ){
			...
			if(strstr($_GET['page'],"socialize") && check_admin_referer('socialize-update-display_options')){
				...
				if ((strlen($border_color)==6||strlen($border_color) == 3)&&isset($_POST['socialize_alert_border_color'])){ $socialize_settings['socialize_alert_border_color']=$_POST['socialize_alert_border_color']; }
				if(isset($_POST['socialize_alert_border_style'])){ $socialize_settings['socialize_alert_border_style']=$_POST['socialize_alert_border_style']; }
				if(isset($_POST['socialize_alert_border_size'])){ $socialize_settings['socialize_alert_border_size']=$_POST['socialize_alert_border_size']; }
				if(isset($_POST['socialize_display_front'])){ $socialize_settings['socialize_display_front']=$_POST['socialize_display_front']; } else { $socialize_settings['socialize_display_front']=''; }
				if(isset($_POST['socialize_display_archives'])){ $socialize_settings['socialize_display_archives']=$_POST['socialize_display_archives']; } else { $socialize_settings['socialize_display_archives']=''; }
				if(isset($_POST['socialize_display_search'])){ $socialize_settings['socialize_display_search']=$_POST['socialize_display_search']; } else { $socialize_settings['socialize_display_search']=''; }
				if(isset($_POST['socialize_display_posts'])){ $socialize_settings['socialize_display_posts']=$_POST['socialize_display_posts']; } else { $socialize_settings['socialize_display_posts']=''; }
                                ...
                                foreach(get_post_types(array('public' => true, '_builtin' => false), 'names') as $custom_post){
                                    if(isset($_POST['socialize_display_custom_'.$custom_post])){ array_push($socialize_settings['socialize_display_custom'], $custom_post); }
                                }
                                if(isset($_POST['socialize_display_pages'])){ $socialize_settings['socialize_display_pages']=$_POST['socialize_display_pages']; } else { $socialize_settings['socialize_display_pages']=''; }
				if(isset($_POST['socialize_display_feed'])){ $socialize_settings['socialize_display_feed']=$_POST['socialize_display_feed']; } else { $socialize_settings['socialize_display_feed']=''; }
				if(isset($_POST['socialize_alert_box'])){ $socialize_settings['socialize_alert_box']=$_POST['socialize_alert_box']; } else { $socialize_settings['socialize_alert_box']=''; }
				if(isset($_POST['socialize_alert_box_pages'])){ $socialize_settings['socialize_alert_box_pages']=$_POST['socialize_alert_box_pages']; } else { $socialize_settings['socialize_alert_box_pages']=''; }
				if(isset($_POST['socialize_float'])){ $socialize_settings['socialize_float']=$_POST['socialize_float']; }
                                if(isset($_POST['socialize_position'])){ $socialize_settings['socialize_position']=$_POST['socialize_position']; }
				if(isset($_POST['socialize_action_template'])){ $socialize_settings['socialize_action_template']=stripslashes($_POST['socialize_action_template']); }
				if(isset($_POST['socialize_css'])){ $socialize_settings['socialize_css']=$_POST['socialize_css']; } else { $socialize_settings['socialize_css']=''; }
	...
	function socialize_services_admin(){
		$socialize_settings = $this->process_socialize_services_admin();
		$socializemeta = explode( ',', $socialize_settings['sharemeta']);
		$socialize_buttons = $this->sort_buttons_array($socializemeta);
		...
		$google_buttons_content = "";
                $google_plusone_buttons_content = "";
		$yahoo_buttons_content = "";
		$linkedin_buttons_content = "";

		if ( function_exists('wp_nonce_field') ){ $default_content .= wp_nonce_field('socialize-update-services_options','_wpnonce',true,false); }
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-default', 'Default Button Setup', $default_content);
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-buttons-facebook', 'Facebook Button Settings', $facebook_buttons_content);
		...
		$twiter_buttons_content .= '<p>' . __("Background Border Color") . '<br />
					...
					<small>Background color Backtype Tweetcount Button</small></p>';
		$twiter_buttons_content .= '</div>';
		$wrapped_content .= $this->socialize_postbox('socialize-settings-buttons-twitter', 'Twitter Button Settings', $twiter_buttons_content);
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-buttons-reddit', 'Reddit Button Settings', $reddit_buttons_content);
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-buttons-stumbleupon', 'Stumbleupon Button Settings', $stumbleupon_buttons_content);

		$google_buttons_content .= '<p>' . __("Choose which Google Buzz button to display") . ':<br />
					<select name="buzz_style">';
						foreach (array('normal-count', 'small-count', 'normal-button', 'small-button', 'link') as $buzz_style){
							$google_buttons_content .= '<option value="' . $buzz_style.'" ' . selected($socialize_settings['buzz_style'], $buzz_style, false) . '>' . $buzz_style . '</option>';
						}
		$google_buttons_content .= '</select></p>';
		$wrapped_content .= $this->socialize_postbox('socialize-settings-buttons-google', 'Google Buzz Button Settings', $google_buttons_content);
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-buttons-google-plusone', 'Google +1 Button Settings', $google_plusone_buttons_content);
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-buttons-yahoo', 'Yahoo Buzz Button Settings', $yahoo_buttons_content);
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-buttons-linkedin', 'LinkedIn Button Settings', $linkedin_buttons_content);
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-buttons-digg', 'Digg Button Settings', $digg_buttons_content);

		$this->socialize_admin_wrap('Socialize: Button Settings', $wrapped_content);
	}
	...
	function process_socialize_services_admin(){
		...
		if ( !empty($_POST['socialize_option_submitted']) ){
			...
			if(strstr($_GET['page'],"socialize") && check_admin_referer('socialize-update-services_options')){
				...
				if(isset($_POST['fb_layout'])){ $socialize_settings['fb_layout']=$_POST['fb_layout']; }
				if(isset($_POST['fb_showfaces'])){ $socialize_settings['fb_showfaces']=$_POST['fb_showfaces']; }
				if(isset($_POST['fb_verb'])){ $socialize_settings['fb_verb']=$_POST['fb_verb']; }
				if(isset($_POST['fb_font'])){ $socialize_settings['fb_font']=$_POST['fb_font']; }
				if(isset($_POST['fb_color'])){ $socialize_settings['fb_color']=$_POST['fb_color']; }
				if(isset($_POST['fb_width'])){ $socialize_settings['fb_width']=$_POST['fb_width']; }
				if(isset($_POST['socialize_twitter_source'])){ $socialize_settings['socialize_twitter_source']=$_POST['socialize_twitter_source']; }
				if(isset($_POST['socialize_topsy_theme'])){ $socialize_settings['socialize_topsy_theme']=$_POST['socialize_topsy_theme']; }
				if(isset($_POST['socialize_topsy_size'])){ $socialize_settings['socialize_topsy_size']=$_POST['socialize_topsy_size']; }
				if(isset($_POST['socialize_twitter_related'])){ $socialize_settings['socialize_twitter_related']=$_POST['socialize_twitter_related']; }
				if(isset($_POST['socialize_twitter_count'])){ $socialize_settings['socialize_twitter_count']=$_POST['socialize_twitter_count']; }
				if(isset($_POST['socialize_tweetmeme_style'])){ $socialize_settings['socialize_tweetmeme_style']=$_POST['socialize_tweetmeme_style']; }
				if(isset($_POST['socialize_tweetcount_via'])){ $socialize_settings['socialize_tweetcount_via']=$_POST['socialize_tweetcount_via']; }
				if(isset($_POST['socialize_tweetcount_links'])){ $socialize_settings['socialize_tweetcount_links']=$_POST['socialize_tweetcount_links']; }
				if(isset($_POST['socialize_tweetcount_size'])){ $socialize_settings['socialize_tweetcount_size']=$_POST['socialize_tweetcount_size']; }
				if(isset($_POST['socialize_tweetcount_background'])){ $socialize_settings['socialize_tweetcount_background']=$_POST['socialize_tweetcount_background']; }
				if(isset($_POST['socialize_tweetcount_border'])){ $socialize_settings['socialize_tweetcount_border']=$_POST['socialize_tweetcount_border']; }
				if(isset($_POST['reddit_type'])){ $socialize_settings['reddit_type']=$_POST['reddit_type']; }
				if(isset($_POST['reddit_bgcolor'])){ $socialize_settings['reddit_bgcolor']=$_POST['reddit_bgcolor']; }
				if(isset($_POST['reddit_bordercolor'])){ $socialize_settings['reddit_bordercolor']=$_POST['reddit_bordercolor']; }
				if(isset($_POST['su_type'])){ $socialize_settings['su_type']=$_POST['su_type']; }
				if(isset($_POST['buzz_style'])){ $socialize_settings['buzz_style']=$_POST['buzz_style']; }
                                if(isset($_POST['plusone_style'])){ $socialize_settings['plusone_style']=$_POST['plusone_style']; }
				if(isset($_POST['digg_size'])){ $socialize_settings['digg_size']=$_POST['digg_size']; }
				if(isset($_POST['yahoo_badgetype'])){ $socialize_settings['yahoo_badgetype']=$_POST['yahoo_badgetype']; }
				if(isset($_POST['linkedin_counter'])){ $socialize_settings['linkedin_counter']=$_POST['linkedin_counter']; }
	...
	function socialize_settings_admin(){
		$socialize_settings = $this->process_socialize_settings_admin();
		...
		if ( function_exists('wp_nonce_field') ){ $bitly_content .= wp_nonce_field('socialize-update-settings_options','_wpnonce',true,false); }
		...
		$wrapped_content .= $this->socialize_postbox('socialize-settings-bitly', 'Bitly Settings', $bitly_content);
                ...
                $og_content .= '<p>' . __("Facebook Admin IDs") . '<br />
                  ...
                  $og_content .= '<p>' . __("Facebook Page ID") . '<br />
				      <input type="text" name="socialize_fb_pageid" value="' . $socialize_settings['socialize_fb_pageid'] . '" />
                                      <small>A Facebook Page ID.</p>';




                $wrapped_content .= $this->socialize_postbox('socialize-settings-facebook', 'Open Graph Settings', $og_content);


		$this->socialize_admin_wrap('Socialize: General Settings', $wrapped_content);
	...
	function process_socialize_settings_admin() {
		...
		if ( !empty($_POST['socialize_option_submitted']) ){
			...
			if(strstr($_GET['page'],"socialize") && check_admin_referer('socialize-update-settings_options')){
				$socialize_settings = get_option('socialize_settings10');
				if(isset($_POST['socialize_bitly_name'])){ $socialize_settings['socialize_bitly_name']=$_POST['socialize_bitly_name']; }
				if(isset($_POST['socialize_bitly_key'])){ $socialize_settings['socialize_bitly_key']=$_POST['socialize_bitly_key']; }
				if(isset($_POST['socialize_fb_appid'])){ $socialize_settings['socialize_fb_appid']=$_POST['socialize_fb_appid']; }
                                if(isset($_POST['socialize_fb_adminid'])){ $socialize_settings['socialize_fb_adminid']=$_POST['socialize_fb_adminid']; }
                                if(isset($_POST['socialize_og'])){ $socialize_settings['socialize_og']=$_POST['socialize_og']; } else { $socialize_settings['socialize_og']=''; }
                                if(isset($_POST['socialize_fb_pageid'])){ $socialize_settings['socialize_fb_pageid']=$_POST['socialize_fb_pageid']; } else { $socialize_settings['socialize_fb_pageid']=''; }
				...
				<div class="postbox-container" style="width:60%;">
					...
					<div class="postbox-container" style="width:30%;">
					  <div class="metabox-holder">
						<div class="meta-box-sortables">
						<?php
							echo $this->socialize_show_donate();
							echo $this->socialize_show_plugin_support();
							echo $this->socialize_show_blogfeed();
						?>
						</div>
					</div>
				</div>
